 ...
 * @version 0.5
 * <p>
 * Double the number of Zzzs you have on a single DreamTile. Gain 1 wink
 */
...
public class DeepSleep extends DreamTile {
    ...
    public DeepSleep() {
        ...
        isInfinite = true;
        description = "DeepSleep: Double The Number Of Zzzs You Have On A Single DreamTile. Gain 1 Wink";
    }
    ...
    public void activateTile(IPlayer player) {
        ...
        //TODO: figure out how to allow player to choose DreamTile to catch Zzzs on
