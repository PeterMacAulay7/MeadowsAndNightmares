 ...
 * @version 0.5
 * <p>
 * Move x spaces. X is equal to the number of movement on the previous player's last player card
 */
...
public class CopyCat extends DreamTile {
    ...
    public CopyCat() {
        ...
        isInfinite = true;
        description = "CopyCat: Move X Spaces. X Is Equal To The Number Of Movement On The Previous Player's Last Played Card";
    }
    ...
    public void activateTile(IPlayer player) {
        ...
        //TODO: figure out how much movement was on the last players card
        //TODO: next Milestone(multiple players)
