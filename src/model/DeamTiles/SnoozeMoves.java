 ...
 * @version 0.5
 * <p>
 * For every 2 Zzz in your supply move 1 space
 */
...
public class SnoozeMoves extends DreamTile {
    ...
    public SnoozeMoves() {
        ...
        isInfinite = true;
        description = "SnoozeMoves: For Every 2 Zzzs In Your Supply, Move 1 Space";
    }

    /**
     * Finds the number of IZzzTokens player has
     * For every 2 IZzzTokens player's ISheepToken moves 1 space
    ...
    public void activateTile(IPlayer player) {
        ...
        //Finds number of IZzzTokens player has
        int numZzzs = player.getZzzTokens().size();

        //Determines number of moves player moves
        int moves = numZzzs / 2;

        //moves player's ISheepToken
        player.getSheepToken().changeInPosition(moves);
